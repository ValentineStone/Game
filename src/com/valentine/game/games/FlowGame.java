...
public class FlowGame extends Yame implements KeyListener
{
	...
	public void update()
	{
		...
		{	
			for (int i = 0; i < 10; i++)
			{
				...
				//System.err.println(getCenterX() + " | " + getCenterY() + " | " + (getWidth() - p) + " | " + (getCenterY() + getCenterY()/10));
				...
				(
					this,
					circle,
					speedSlider.getValue() * 0.05 + 0.01,
					d,
					a
				);
			}
